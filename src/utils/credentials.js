...
const LoginSpotify = () => {
  window.location = `${SPOTIFY_AUTHORIZE_URL}?client_id=${CLIENT_ID}&redirect_uri=https://final-project-ahmad-junaedi.netlify.app/=${SCOPE}&response_type=token&show_dialog=true`;
};
